            ...
            {todos.map((todo) =>
                <div className="single-todo-container" key={todo._id}>
                    ...
                    <button className="todo-delete" onClick={() => deleteTodo(todo._id)}>
                        <svg fill="var(--text-varient)" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="32px" height="32px" viewBox="0 0 482.428 482.429"
                            xml:space="preserve">
                            <g>
                                <g>
